...
public class GRCPage2 extends GRCPageobject {

	ExtentTest test;
	public static String e = "";

	public GRCPage2(WebDriver driver, ExtentReports extentreport, String GRCMobileNumber, String GRCNewCompanyName,
...
//		driver.switchTo().window(all7.get(1));
		...
		GRCUsername.sendKeys("8056016697");
		Thread.sleep(2500);
...
//	OpenEntityList.click();
		...
		try {
		js1.executeScript("arguments[0].scrollIntoView(true);", FirstTimeInIndia);
		
		
		Knowmore.click();
		Thread.sleep(1500);
		KnowmoreClosePopup.click();
		Thread.sleep(1500);
		Unlocknow.click();
		Thread.sleep(1500);
		UnlocknowClosePopup.click();
		Thread.sleep(1500);
		}catch(Exception otherpartner){
			
			
			System.out.println(otherpartner);
...
//		Thread.sleep(4000);
		...
		try {
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(text(),'Need help')]")))
					.click();
			Thread.sleep(3000);
		...
		try {
			Thread.sleep(3000);
			WebElement element5 = driver.findElement(By.xpath("//button[@class='styles_closeBtn__ULw05']/parent::div/child::button"));
		...
		Thread.sleep(5500);
		// **********
		WebElement element71 = driver.findElement(By.xpath("//img[@alt='Settings']/parent::button"));
		JavascriptExecutor executor71 = (JavascriptExecutor) driver;
		executor71.executeScript("arguments[0].click();", element71);
		Thread.sleep(5500);
		...
		SearchAllSevice.click();
		SearchAllSevice.sendKeys("Online company registration");
		Onlinecompanyregstration.click();
...
// BuyNowService.click();**/
		...
		Thread.sleep(5500);
		driver.findElement(By.xpath("//div[@class='styles_container__6vyhB']/child::img")).click();
		...
		if (MyServicesURL.contains(MyServicesURL1)) {
			...
			MyserviceCompleted.click();
			MyserviceDiscontinued.click();
			MyserviceExpired.click();
...
//System.out.println(Ticketid1);
		...
		MyintrestKnowmore.click();
		Thread.sleep(1500);
		MyintrestKnowMorePopupClose.click();
